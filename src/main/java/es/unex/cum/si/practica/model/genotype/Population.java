 ...
 * It also provides methods to select and crossover individuals.
 */
public class Population {
    ...
    public Individual[] nPointCrossover(Individual parentA, Individual parentB, int n) {
        ...
        for (i = 0; i < parentA.getChromosome().length; i++) {
            if (crossoverPointIndex < n && i == randomPoints[crossoverPointIndex]) {
                swap = !swap;
                crossoverPointIndex++;
            }
