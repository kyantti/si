...
/**
 * The Driver class runs the evolutionary algorithm to generate a schedule.
 * The configuration of the algorithm can be changed in the config.properties file.
 */
public class Driver {
